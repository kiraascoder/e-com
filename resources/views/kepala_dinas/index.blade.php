...
@section('content')
    ...
    @include('partials.dashboard-header', [
        ...
        'roleTitle' => 'Kepala Dinas ' . (Auth::user()->bidang->nama ?? 'PU'),
        'description' => ' Pantau kinerja bidang ' . (Auth::user()->bidang->nama ?? 'Anda'),
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @include('partials.quick-action', [
                    'title' => 'Saran Warga',
                    'description' => 'Lihat saran & feedback dari masyarakat',
                    'bgColor' => 'bg-yellow-100',
                    'link' => route('dinas.saran'), // pastikan route ini ada
                    'hoverColor' => 'bg-yellow-200',
                    'iconColor' => 'text-yellow-600',
                    'icon' => '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                  d="M7 8h10M7 12h6m-6 8l-4-4V6a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H7z"></path>
                                                       </svg>',
                ])
            </div>
        </div>
